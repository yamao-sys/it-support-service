...
type SupporterService interface {
	SignIn(ctx context.Context, requestParams supporters.PostSupportersSignInJSONRequestBody) (statusCode int64, tokenString string, error error)
}
...
func (ss *supporterService) SignIn(ctx context.Context, requestParams supporters.PostSupportersSignInJSONRequestBody) (statusCode int64, tokenString string, error error) {
	// NOTE: emailからの取得
