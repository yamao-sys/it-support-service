...
type CompanyService interface {
	SignIn(ctx context.Context, requestParams businessapi.PostCompaniesSignInJSONRequestBody) (statusCode int64, tokenString string, error error)
}
...
func (cs *companyService) SignIn(ctx context.Context, requestParams businessapi.PostCompaniesSignInJSONRequestBody) (statusCode int64, tokenString string, error error) {
	// NOTE: emailからの取得
