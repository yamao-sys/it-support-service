...
func (s *TestProjectServiceSuite) TestProjectCreate_BadRequest_Required() {
	...
	minBudget := 10000
	maxBudget := 20000
	requestParams := businessapi.PostProjectsJSONRequestBody{Title: &title, Description: &description, StartDate: nil, EndDate: nil, MinBudget: &minBudget, MaxBudget: &maxBudget, IsActive: nil}
